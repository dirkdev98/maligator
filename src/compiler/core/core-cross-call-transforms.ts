...
function collectInstanceMethodHints(
	program: CoreProgram,
...
function offerFunctionCandidates(
	...
	for (const site of outgoing) {
		...
		const hintedTarget =
			...
			inLoop
				? instanceMethodHint(fn, site.callee, site.receiver, instanceMethodHints)
				: undefined;
...
export function discoverCoreCrossCallCandidates(
	...
	const instanceMethodHints = collectInstanceMethodHints(program);
