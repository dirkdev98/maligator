declare module "maligator:test" {
	/**
	 * A test or hook body. Maligator waits for a returned promise or thenable
	 * before advancing the lifecycle.
	 */
	 ...
	 * {@link expect.objectContaining}. It may be nested inside `toEqual`,
	 * `toStrictEqual`, and `toMatchObject` expectations.
	 */
	...
	/**
	 * Promise-returning matcher surface exposed by {@link Matchers.resolves} and
	 * {@link Matchers.rejects}. Await these calls so the test cannot finish before
	 * the assertion.
	 */
