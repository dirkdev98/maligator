...
function run(scale) {
	...
	for (let index = 0; index < operations; index++) {
		const value = allocate(Int32Array, 8);
...
function verify() {
	for (const value of retained) {
		if (!(value instanceof Int32Array) || value.length !== 8) {
...
runRuntimeGapCase("indirect-typed-array-construction-indirect-multiple-8", run, verify);
