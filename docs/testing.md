...
| ----- | -------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Smoke | `npm run test:smoke` | Bail, 20s warm / 4m cold at 4 workers | Minimal compiler, packaged development, Test262, and WPT capability proof                        |
...
20 seconds on a warm four-worker run. It allows four minutes when the reusable
