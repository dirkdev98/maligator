...
- [x] Add a real server-main testharness adapter, pin a WPT revision, record
      ...
      lane now runs 153 subtests from 22 byte-pinned Abort, Encoding, Headers, timers,
      URL, and URLSearchParams files with no expected, unexpected, or stale
