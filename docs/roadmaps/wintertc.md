...
| Timers                                               |   P    | Reactor-backed timeout/interval scheduling and shared cancellation IDs are in `runtime/src/runtime/host_timer.c`; pending tasks are kept in registration order with native normal/stress coverage, including equal-delay timers and AbortSignal timeout ordering.                                                                                                                                                                                                                                                                             | Required coercions/errors, nesting clamp and overflow rules, exception reporting, isolate-owned timer state, and the chosen server-global rule for string handlers. Non-callables currently return id 0 (`host_timer.c:160-183`).                          |
