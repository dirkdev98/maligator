...
static const MalInstruction mal_function_0_instructions[] = {
    ...
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 6, .target_ip = 527 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 530 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 2, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 533 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 2, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 533 } },
    ...
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 540 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 543 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 1, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 546 } },
    ...
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 6, .target_ip = 552 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 555 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 558 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 558 } },
    ...
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 606 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 612 } },
