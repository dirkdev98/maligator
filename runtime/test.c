...
static const c16 mal_string_45_code_units[] = { 109, 97, 120 };
static const c16 mal_string_46_code_units[] = { 109, 105, 110 };
static const c16 mal_string_47_code_units[] = { 97, 98, 115 };
static const c16 mal_string_48_code_units[] = { 102, 108, 111, 111, 114 };
static const c16 mal_string_49_code_units[] = { 114, 111, 117, 110, 100 };
static const c16 mal_string_50_code_units[] = { 116, 114, 117, 110, 99 };
static const c16 mal_string_51_code_units[] = { 112, 111, 119 };
static const c16 mal_string_52_code_units[] = { 115, 116, 114, 105, 110, 103, 105, 102, 121 };
static const c16 mal_string_53_code_units[] = { 97 };
static const c16 mal_string_54_code_units[] = { 98 };
static const c16 mal_string_55_code_units[] = { 112, 97, 114, 115, 101 };
static const c16 mal_string_56_code_units[] = { 77, 97, 116, 104 };
static const c16 mal_string_57_code_units[] = { 108, 111, 103 };
static const c16 mal_string_58_code_units[] = { 109, 97, 108, 105, 103, 97, 116, 111, 114, 32, 102, 105, 120, 116, 117, 114, 101, 32, 114, 101, 115, 117, 108, 116, 32, 105, 110, 99, 111, 109, 105, 110, 103, 58 };
static const c16 mal_string_59_code_units[] = { 114, 101, 115, 117, 108, 116, 58 };
static const c16 mal_string_60_code_units[] = { 116, 109, 112, 50, 46, 106, 115, 32, 101, 120, 112, 101, 99, 116, 101, 100, 32, 114, 101, 115, 117, 108, 116, 32, 49, 50, 53, 50, 32, 98, 117, 116, 32, 103, 111, 116, 32 };
...
static const MalStringConstant mal_string_constants[] = {
    ...
    { .length = 3, .code_units = mal_string_45_code_units },
    { .length = 3, .code_units = mal_string_46_code_units },
    { .length = 3, .code_units = mal_string_47_code_units },
    { .length = 5, .code_units = mal_string_48_code_units },
    { .length = 5, .code_units = mal_string_49_code_units },
    { .length = 5, .code_units = mal_string_50_code_units },
    { .length = 3, .code_units = mal_string_51_code_units },
    { .length = 9, .code_units = mal_string_52_code_units },
    { .length = 1, .code_units = mal_string_53_code_units },
    { .length = 1, .code_units = mal_string_54_code_units },
    { .length = 5, .code_units = mal_string_55_code_units },
    { .length = 4, .code_units = mal_string_56_code_units },
    { .length = 3, .code_units = mal_string_57_code_units },
    { .length = 34, .code_units = mal_string_58_code_units },
    { .length = 7, .code_units = mal_string_59_code_units },
    { .length = 37, .code_units = mal_string_60_code_units },
};
...
static const MalInstruction mal_function_0_instructions[] = {
    ...
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 640 } },
    { .opcode = MAL_OP_CREATE_UNDEFINED, .as.create_undefined = { .dst = 3 } },
    { .opcode = MAL_OP_UNARY, .as.unary = { .dst = 6, .src = 3, .op = MAL_UNARY_TYPEOF } },
    ...
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 646 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 649 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 3, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 652 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 3, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 652 } },
    ...
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 6, .right = 0, .op = MAL_BIN_STRICT_EQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 4, .target_ip = 658 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 661 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 4, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 4 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 664 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 4, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 4 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 664 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 3, .right = 0, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 3, .right = 0, .op = MAL_BIN_STRICT_EQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 6, .target_ip = 671 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 674 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 677 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 677 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 4, .right = 0, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 3, .left = 4, .right = 0, .op = MAL_BIN_STRICT_EQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 3, .target_ip = 684 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 687 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 3, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 3 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 690 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 3, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 3 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 690 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 3, .left = 6, .right = 0, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 6, .right = 0, .op = MAL_BIN_STRICT_EQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 4, .target_ip = 697 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 700 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 4, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 4 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 703 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 4, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 4 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 703 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 3, .right = 0, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 0, .string_index = 41 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 3, .right = 0, .op = MAL_BIN_STRICT_EQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 6, .target_ip = 710 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 713 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 716 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 716 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 4, .right = 0, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 6, .index = 43 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 29 } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 722 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 725 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 4, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 728 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 4, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 728 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 30 } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 731 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 734 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 3, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 737 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 3, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 737 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 4, .right = 3, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 32 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 0, .right = 6, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 33 } },
    ...
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 3, .index = 36 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 0, .right = 3, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 3, .index = 37 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 4, .right = 3, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 3, .index = 38 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 0, .right = 3, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 40 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 4, .right = 6, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 3, .right = 0, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 6, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 41 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 3, .index = 42 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 0, .right = 3, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 3, .left = 6, .right = 4, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 3, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 3, .index = 17 } },
    ...
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 3, .left = 6, .right = 0, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 3, .index = 17 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 3, .intrinsic = MAL_INTRINSIC_MATH } },
    ...
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 1, .callee = 6, .this_value = 3, .argument_count = 2, .arguments = (const i32[]) { 0, 4 } } },
    ...
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 2 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 5 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 2, .callee = 3, .this_value = 4, .argument_count = 2, .arguments = (const i32[]) { 0, 6 } } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 1, .right = 2, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 2, .intrinsic = MAL_INTRINSIC_MATH } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 47 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 0, .object = 2, .key = 1 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 1, .value = 3 } },
    { .opcode = MAL_OP_UNARY, .as.unary = { .dst = 4, .src = 1, .op = MAL_UNARY_NEGATE } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 1, .callee = 0, .this_value = 2, .argument_count = 1, .arguments = (const i32[]) { 4 } } },
    ...
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 2, .object = 1, .key = 6 } },
    { .opcode = MAL_OP_CREATE_F64, .as.create_f64 = { .dst = 6, .value = 2.9e+0 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 0, .callee = 2, .this_value = 1, .argument_count = 1, .arguments = (const i32[]) { 6 } } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 4, .right = 0, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 0, .intrinsic = MAL_INTRINSIC_MATH } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 4, .string_index = 49 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 1, .object = 0, .key = 4 } },
    { .opcode = MAL_OP_CREATE_F64, .as.create_f64 = { .dst = 4, .value = 2.5e+0 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 2, .callee = 1, .this_value = 0, .argument_count = 1, .arguments = (const i32[]) { 4 } } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 6, .right = 2, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 2, .intrinsic = MAL_INTRINSIC_MATH } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 6, .string_index = 50 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 0, .object = 2, .key = 6 } },
    { .opcode = MAL_OP_CREATE_F64, .as.create_f64 = { .dst = 6, .value = 1.8e+0 } },
    { .opcode = MAL_OP_UNARY, .as.unary = { .dst = 1, .src = 6, .op = MAL_UNARY_NEGATE } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 6, .callee = 0, .this_value = 2, .argument_count = 1, .arguments = (const i32[]) { 1 } } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 1, .left = 4, .right = 6, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 1, .index = 44 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 1, .intrinsic = MAL_INTRINSIC_MATH } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 6, .string_index = 51 } },
    ...
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 2, .value = 10 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 0, .callee = 4, .this_value = 1, .argument_count = 2, .arguments = (const i32[]) { 6, 2 } } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 0, .index = 45 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 0, .intrinsic = MAL_INTRINSIC_JSON } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 2, .string_index = 52 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 6, .object = 0, .key = 2 } },
    { .opcode = MAL_OP_CREATE_OBJECT, .as.create_object = { .dst = 2 } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 53 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 4, .value = 1 } },
    ...
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 3, .value = 0 } },
    { .opcode = MAL_OP_CREATE_BOOLEAN, .as.create_boolean = { .dst = 5, .value = 1 } },
    { .opcode = MAL_OP_STORE_PROPERTY, .as.store_property = { .object = 1, .key = 3, .value = 5 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 5, .value = 1 } },
    { .opcode = MAL_OP_CREATE_NULL, .as.create_null = { .dst = 3 } },
    { .opcode = MAL_OP_STORE_PROPERTY, .as.store_property = { .object = 1, .key = 5, .value = 3 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 3, .value = 2 } },
    ...
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 1, .callee = 6, .this_value = 0, .argument_count = 1, .arguments = (const i32[]) { 2 } } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 1, .index = 46 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 1, .intrinsic = MAL_INTRINSIC_JSON } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 2, .string_index = 55 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 0, .object = 1, .key = 2 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 2, .index = 46 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 6, .callee = 0, .this_value = 1, .argument_count = 1, .arguments = (const i32[]) { 2 } } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 6, .index = 47 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 6, .intrinsic = MAL_INTRINSIC_GLOBAL_THIS } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 2, .string_index = 56 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 1, .object = 6, .key = 2 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 2, .intrinsic = MAL_INTRINSIC_MATH } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 1, .right = 2, .op = MAL_BIN_STRICT_EQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 6, .target_ip = 861 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 864 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 2, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 867 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 2, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 867 } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 2, .index = 48 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 2, .intrinsic = MAL_INTRINSIC_IS_NAN } },
    { .opcode = MAL_OP_CREATE_UNDEFINED, .as.create_undefined = { .dst = 6 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 1, .intrinsic = MAL_INTRINSIC_NAN_VALUE } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 0, .callee = 2, .this_value = 6, .argument_count = 1, .arguments = (const i32[]) { 1 } } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 874 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 877 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 1, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 880 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 1, .src = 0 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 880 } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 1, .index = 49 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 1, .intrinsic = MAL_INTRINSIC_INFINITY_VALUE } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 0, .value = 1000000 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 1, .right = 0, .op = MAL_BIN_GT } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 6, .target_ip = 886 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 889 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 1 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 892 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 6, .value = 0 } },
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 6 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 892 } },
    ...
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 6, .string_index = 57 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 1, .object = 0, .key = 6 } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 6, .string_index = 58 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 2, .index = 45 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 3, .callee = 1, .this_value = 0, .argument_count = 2, .arguments = (const i32[]) { 6, 2 } } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 2, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 44 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 2, .right = 6, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 0, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 45 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 2, .left = 0, .right = 6, .op = MAL_BIN_ADD } },
    ...
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 0, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 17 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 1, .index = 47 } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 2, .string_index = 54 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 6, .object = 1, .key = 2 } },
    ...
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 49 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 6, .left = 1, .right = 0, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 0, .index = 50 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 1, .left = 6, .right = 0, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 2, .right = 1, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_STORE_GLOBAL, .as.store_global = { .src = 0, .index = 17 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 0, .intrinsic = MAL_INTRINSIC_CONSOLE } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 57 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 2, .object = 0, .key = 1 } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 59 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 17 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 3, .callee = 2, .this_value = 0, .argument_count = 2, .arguments = (const i32[]) { 1, 6 } } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 17 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 1, .value = 1252 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 6, .right = 1, .op = MAL_BIN_STRICT_NEQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 940 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 946 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 0, .intrinsic = MAL_INTRINSIC_ERROR_CONSTRUCTOR } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 60 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 6, .index = 17 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 2, .left = 1, .right = 6, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_CONSTRUCT, .as.construct = { .dst = 6, .callee = 0, .argument_count = 1, .arguments = (const i32[]) { 2 } } },
    { .opcode = MAL_OP_THROW, .as.thrown = { .value = 6 } },
    { .opcode = MAL_OP_CREATE_UNDEFINED, .as.create_undefined = { .dst = 6 } },
    { .opcode = MAL_OP_RETURN, .as.ret = { .value = 6 } },
};
