...
static const MalInstruction mal_function_0_instructions[] = {
    ...
    { .opcode = MAL_OP_MOVE, .as.move = { .dst = 0, .src = 1 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 4, .callee = 3, .this_value = 2, .argument_count = 1, .arguments = (const i32[]) { 0 } } },
    ...
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 10, .callee = 4, .this_value = 0, .argument_count = 7, .arguments = (const i32[]) { 2, 3, 5, 6, 7, 8, 9 } } },
    ...
    { .opcode = MAL_OP_CONSTRUCT, .as.construct = { .dst = 9, .callee = 7, .argument_count = 1, .arguments = (const i32[]) { 6 } } },
    ...
    { .opcode = MAL_OP_CONSTRUCT, .as.construct = { .dst = 9, .callee = 7, .argument_count = 1, .arguments = (const i32[]) { 8 } } },
    { .opcode = MAL_OP_THROW, .as.thrown = { .value = 9 } },
