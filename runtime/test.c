...
static const c16 mal_string_129_code_units[] = { 114, 101, 115, 117, 108, 116, 58 };
static const c16 mal_string_130_code_units[] = { 116, 109, 112, 50, 46, 106, 115, 32, 101, 120, 112, 101, 99, 116, 101, 100, 32, 114, 101, 115, 117, 108, 116, 32, 49, 54, 57, 54, 32, 98, 117, 116, 32, 103, 111, 116, 32 };
...
static const MalStringConstant mal_string_constants[] = {
    ...
    { .length = 7, .code_units = mal_string_129_code_units },
    { .length = 37, .code_units = mal_string_130_code_units },
};
...
static const MalInstruction mal_function_0_instructions[] = {
    ...
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 94 } },
    { .opcode = MAL_OP_LOAD_PROPERTY, .as.load_property = { .dst = 4, .object = 0, .key = 1 } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 129 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 8, .index = 17 } },
    { .opcode = MAL_OP_CALL, .as.call = { .dst = 2, .callee = 4, .this_value = 0, .argument_count = 2, .arguments = (const i32[]) { 1, 8 } } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 8, .index = 17 } },
    { .opcode = MAL_OP_CREATE_NUMBER, .as.create_number = { .dst = 1, .value = 1696 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 0, .left = 8, .right = 1, .op = MAL_BIN_STRICT_NEQ } },
    { .opcode = MAL_OP_JUMP_IF, .as.jump_if = { .cond = 0, .target_ip = 2419 } },
    { .opcode = MAL_OP_JUMP, .as.jump = { .target_ip = 2425 } },
    { .opcode = MAL_OP_LOAD_INTRINSIC, .as.load_intrinsic = { .dst = 0, .intrinsic = MAL_INTRINSIC_ERROR_CONSTRUCTOR } },
    { .opcode = MAL_OP_CREATE_STRING, .as.create_string = { .dst = 1, .string_index = 130 } },
    { .opcode = MAL_OP_LOAD_GLOBAL, .as.load_global = { .dst = 8, .index = 17 } },
    { .opcode = MAL_OP_BINARY, .as.binary = { .dst = 4, .left = 1, .right = 8, .op = MAL_BIN_ADD } },
    { .opcode = MAL_OP_CONSTRUCT, .as.construct = { .dst = 8, .callee = 0, .argument_count = 1, .arguments = (const i32[]) { 4 } } },
    { .opcode = MAL_OP_THROW, .as.thrown = { .value = 8 } },
    { .opcode = MAL_OP_CREATE_UNDEFINED, .as.create_undefined = { .dst = 8 } },
    { .opcode = MAL_OP_RETURN, .as.ret = { .value = 8 } },
};
