...
static MalValue mal_builtin_boolean_constructor(MalVm *vm, MalValue this_value, const MalValue *args, i32 arg_count) {
    (void) vm;
    (void) this_value;
...
static MalValue mal_builtin_boolean_prototype_to_string(MalVm *vm, MalValue this_value, const MalValue *args, i32 arg_count) {
    (void) args;
    (void) arg_count;
    return mal_value_from_string(mal_intrinsic_ascii(vm, mal_value_is_truthy(this_value) ? "true" : "false"));
}

static MalValue mal_builtin_boolean_prototype_value_of(MalVm *vm, MalValue this_value, const MalValue *args, i32 arg_count) {
    (void) vm;
    (void) args;
    (void) arg_count;
