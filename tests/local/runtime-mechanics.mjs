...
const descriptorTransitions = {};
for (let index = 0; index < 40; index++) {
	descriptorTransitions["field" + index] = index;
}
let transitionSetterValue = 0;
Object.defineProperty(descriptorTransitions, "field39", {
	get() {
		return 41;
	},
	set(value) {
		transitionSetterValue = value;
	},
	enumerable: false,
	configurable: true,
});
descriptorTransitions.field39 = 42;
const accessorTransition = Object.getOwnPropertyDescriptor(
	descriptorTransitions,
	"field39",
);
Object.defineProperty(descriptorTransitions, "field39", {
	value: 43,
...
const dataTransition = Object.getOwnPropertyDescriptor(descriptorTransitions, "field39");
checks.push(
	transitionSetterValue === 42,
	accessorTransition.get !== undefined,
	accessorTransition.set !== undefined,
	accessorTransition.enumerable === false,
	descriptorTransitions.field39 === 43,
	dataTransition.value === 43,
	dataTransition.writable === true,
	dataTransition.enumerable === true,
	dataTransition.configurable === true,
	delete descriptorTransitions.field39,
	!("field39" in descriptorTransitions),
);
descriptorTransitions.field39 = 44;
checks.push(
	descriptorTransitions.field39 === 44,
	Object.getOwnPropertyDescriptor(descriptorTransitions, "field39").enumerable,
	Reflect.ownKeys(descriptorTransitions).at(-1) === "field39",
);
