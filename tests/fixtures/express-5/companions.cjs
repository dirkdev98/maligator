...
const checks = [
	...
	typeof os.machine() === "string" && os.machine().length > 0,
	typeof os.version() === "string" && os.version().length > 0,
	Number.isFinite(os.freemem()) && os.freemem() >= 0,
	Number.isFinite(os.totalmem()) && os.totalmem() > 0,
	os.totalmem() >= os.freemem(),
	Number.isFinite(os.uptime()) && os.uptime() >= 0,
	Array.isArray(os.loadavg()) && os.loadavg().length === 3,
	typeof os.userInfo().username === "string",
	typeof os.userInfo().uid === "number" && typeof os.userInfo().gid === "number",
