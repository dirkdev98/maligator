...
- [ ] WinterTC surface (opt-in): remaining fetch/Headers bits (`AbortSignal.any`,
      ...
      WPT harness.
- [ ] Complete `package.json#exports` resolution. Exact entries, condition objects,
      arrays, and explicit subpaths work; add wildcard/pattern subpaths, null targets,
      and the remaining target-validation / encapsulation behavior.
