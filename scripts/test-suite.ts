...
// Cold CI builds both the development runtime and the eval-enabled Test262 runtime.
const COLD_SMOKE_FUSE_MS = 900_000;
...
Commands:
  npm run test:smoke          20-second warm / fifteen-minute cold fuse at four workers
